...
QT_MOC_LITERAL(16, 162, 16),
QT_MOC_LITERAL(17, 179, 13),
QT_MOC_LITERAL(18, 193, 18),
QT_MOC_LITERAL(19, 212, 4)
    },
    ...
    "lr\0processedNum\0num\0processVideoStop\0"
    "flagVideoStop\0processedMouseCtrl\0ctrl"
};
...
void Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: _t->processVideoStop((*reinterpret_cast< const bool(*)>(_a[1]))); break;
        case 9: _t->processedMouseCtrl((*reinterpret_cast< const int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Player::*_t)(const bool & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Player::processVideoStop)) {
                *result = 8;
            }
        }
        {
            typedef void (Player::*_t)(const int & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Player::processedMouseCtrl)) {
                *result = 9;
            }
        }
    }
...
// SIGNAL 8
void Player::processVideoStop(const bool & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 9
void Player::processedMouseCtrl(const int & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
