...
void Player::inittrackbar(){
    ...
    createTrackbar("H-Upper", "trackbar_nn", &c_upper[0][0], 180);
    createTrackbar("H-Lower", "trackbar_nn", &c_lower[0][0], 180);
    createTrackbar("S-Upper", "trackbar_nn", &c_upper[0][1], 255);
    createTrackbar("S-Lower", "trackbar_nn", &c_lower[0][1], 255);
    createTrackbar("L-Upper", "trackbar_nn", &c_upper[0][2], 255);
    createTrackbar("L-Lower", "trackbar_nn", &c_lower[0][2], 255);
    createTrackbar("Threshsold static", "trackbar_nn", &threshold_bar_static, 255);
}
    ...
    while(!stop){
       ...
       if(flagVideo){
        ...
        while(1){
            ...
            average(&m);
            float per;
            namedWindow("trackbar_nn", CV_WINDOW_KEEPRATIO);
            inittrackbar();
